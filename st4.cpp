...
void Car::Edit()
{
	int inp = 0;
	NewLine();
	cout << "Model?: ";cin >> this -> sModel;
	NewLine();
	cout << "Color?: ";cin >> this-> sColor;
	NewLine();
	cout << "Number? (1-char, 2-num):"; cin >> inp;
	switch (inp) {
		case 1:
			this->uNum.isChar=true;
			cout<<"8 characters: ";cin >> this->uNum.uNumber.ch;
			break;
		case 2:
			this ->uNum.isChar = false;
			cout << " 5-digit number: "; cin >> this ->uNum.uNumber.si;
			break;
		default: ;
	}
}
...
void Car::Print()
{
	...
	if (this->uNum.isChar) {cout << this->uNum.uNumber.ch;} else {cout << this->uNum.uNumber.si;}
}
